...
@class GTGitHistoryManager, GTGitRepository, NSArray, NSArrayController, NSButton, NSColor, NSUserDefaults;

@interface GTCherryPickRevisionsDialogueViewController : GTDialogueViewController
{
    ...
    NSButton *_usesFastForwardCheckbox;
    NSArray *_revisions;
...
@property(nonatomic) __weak NSButton *usesFastForwardCheckbox; // @synthesize usesFastForwardCheckbox=_usesFastForwardCheckbox;
...
- (void)autoCommitsCheckboxStateDidChange:(id)arg1;
- (unsigned long long)cherryPickOptions;
...
@property(readonly, nonatomic) NSColor *fastForwardDescriptionTextColor;
@property(readonly, nonatomic) NSColor *mainlineDescriptionTextColor;
@property(readonly, nonatomic) BOOL usesFastForward;
