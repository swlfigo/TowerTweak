...
@class GTDialogueWindowController, GTServiceAccountCredentials, GTServicesGitSwarmAccountController, GTStateManager, NSAlert, NSButton, NSString;

@interface GTGettingStartedServicesGitSwarmAccountViewController : GTViewController <GTServicesGitSwarmAccountControllerDelegate>
{
    BOOL _validating;
