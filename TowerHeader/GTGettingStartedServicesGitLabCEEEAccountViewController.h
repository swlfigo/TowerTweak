...
@class GTDialogueWindowController, GTServiceAccountCredentials, GTServicesGitLabCEEEAccountController, GTStateManager, NSAlert, NSButton, NSString;

@interface GTGettingStartedServicesGitLabCEEEAccountViewController : GTViewController <GTServicesGitLabCEEEAccountControllerDelegate>
{
    BOOL _validating;
