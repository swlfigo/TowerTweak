...
@class GTSearchScopeFilter, NSArray, NSString;
@protocol GTAutocompleteItemControllerDelegate;

@interface GTRepositoryActivityRepositoryAutocompleteItemController : NSObject <GTAutocompleteItemController>
{
    BOOL _loading;
...
- (BOOL)repositoryMatchesSearchPattern:(id)arg1;
- (void)cancel;
- (void)reset;
