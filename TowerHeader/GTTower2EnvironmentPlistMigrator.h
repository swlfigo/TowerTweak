...
@interface GTTower2EnvironmentPlistMigrator : NSObject <GTTower2DataMigrator>
{
...
@property(readonly, nonatomic) NSURL *destinationEnvironmentPlistFileURL;
@property(readonly, nonatomic) NSURL *sourceEnvironmentPlistFileURL;
