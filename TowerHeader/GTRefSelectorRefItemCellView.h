...
@class GTRefSelectorRefItem, NSColor, NSImage, NSLayoutConstraint, NSString;

@interface GTRefSelectorRefItemCellView : NSTableCellView
{
    NSLayoutConstraint *_leadingConstraint;
    NSImage *_icon;
    NSString *_refName;
    GTRefSelectorRefItem *_item;
    NSColor *_fontColor;
}

+ (double)height;
+ (id)keyPathsForValuesAffectingRefName;
...
@property(retain, nonatomic) GTRefSelectorRefItem *item; // @synthesize item=_item;
