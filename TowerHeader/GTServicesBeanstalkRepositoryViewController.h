...
@class GTServiceAccount, GTServiceRepositoryCreationInfo, GTServicesBeanstalkRepositoryController, GTStateManager;

@interface GTServicesBeanstalkRepositoryViewController : GTDialogueViewController
{
    GTServiceAccount *_serviceAccount;
    GTServiceRepositoryCreationInfo *_serviceRepositoryCreationInfo;
    GTServicesBeanstalkRepositoryController *_repositoryController;
...
@property(retain, nonatomic) GTServicesBeanstalkRepositoryController *repositoryController; // @synthesize repositoryController=_repositoryController;
