...
@class GTCollapsableView, GTGitErrorController, GTGitRemoteConnection, GTGitRemoteConnectionValidator, GTGitRemoteConnectionViewController, GTGitRemoteNameInputValidator, GTGitRemoteURL, GTGitRepository, GTStateManager, NSString;

@interface GTAddRemoteToRepositoryViewController : GTDialogueViewController <GTGitRemoteConnectionValidatorDelegate>
{
    BOOL _validating;
