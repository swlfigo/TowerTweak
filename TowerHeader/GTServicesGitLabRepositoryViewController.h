...
@class GTServiceAccount, GTServiceRepositoryCreationInfo, GTServicesGitLabRepositoryController, GTStateManager;

@interface GTServicesGitLabRepositoryViewController : GTDialogueViewController
{
    GTServiceAccount *_serviceAccount;
    GTServiceRepositoryCreationInfo *_serviceRepositoryCreationInfo;
    GTServicesGitLabRepositoryController *_repositoryController;
...
@property(retain, nonatomic) GTServicesGitLabRepositoryController *repositoryController; // @synthesize repositoryController=_repositoryController;
