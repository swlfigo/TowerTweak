...
@class GTBackgroundSession, GTGitHistoryManager, GTGitRepository, GTSearchScopeFilter, NSArray, NSOperationQueue, NSString;
@protocol GTAutocompleteItemControllerDelegate;

@interface GTHistoryFileAutocompleteItemController : NSObject <GTAutocompleteItemController>
{
    BOOL _loading;
...
- (void)historyFileAutocompleteItemControllerDidLoadTreeEntries:(id)arg1 task:(id)arg2;
- (void)loadItems;
