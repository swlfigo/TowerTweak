...
@class GTCollapsableView, GTGitErrorController, GTGitRemoteConnection, GTGitRemoteConnectionValidator, GTGitRemoteConnectionViewController, GTGitRemoteURL, GTGitRepository, GTGitSubmodule, GTStateManager, NSString;

@interface GTEditSubmoduleURLViewController : GTDialogueViewController <GTGitRemoteConnectionValidatorDelegate>
{
    BOOL _validating;
