...
@class GTDialogueWindowController, GTServiceAccount, GTServiceAccountCredentials, GTServicesGitLabAccountController, GTStateManager, NSAlert, NSString;

@interface GTServicesGitLabAccountViewController : GTDialogueViewController <GTServicesGitLabAccountControllerDelegate>
{
    BOOL _validating;
