...
@class GTDialogueWindowController, GTServiceAccountCredentials, GTServicesAzureDevOpsAccountController, GTStateManager, NSAlert, NSButton, NSString;

@interface GTGettingStartedServicesAzureDevOpsAccountViewController : GTViewController <GTServicesAzureDevOpsAccountControllerDelegate>
{
    BOOL _validating;
