...
@class GTServiceAccount, GTServiceRepositoryCreationInfo, GTServicesBitbucketRepositoryController, GTStateManager;

@interface GTServicesBitbucketRepositoryViewController : GTDialogueViewController
{
    GTServiceAccount *_serviceAccount;
    GTServiceRepositoryCreationInfo *_serviceRepositoryCreationInfo;
    GTServicesBitbucketRepositoryController *_repositoryController;
...
@property(retain, nonatomic) GTServicesBitbucketRepositoryController *repositoryController; // @synthesize repositoryController=_repositoryController;
