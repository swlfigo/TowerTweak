...
@class GTBackgroundSession, GTGitHistoryManager, GTGitRepository, GTGitRevisionRange, GTSearchScopeFilter, NSArray, NSOperationQueue, NSString;
@protocol GTAutocompleteItemControllerDelegate;

@interface GTPullRequestsCommitsFileAutocompleteItemController : NSObject <GTAutocompleteItemController>
{
    BOOL _loading;
...
- (void)historyManagerDidLoadTreeEntries:(id)arg1 task:(id)arg2;
- (void)loadItems;
