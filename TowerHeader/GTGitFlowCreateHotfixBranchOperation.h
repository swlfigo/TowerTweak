...
@interface GTGitFlowCreateHotfixBranchOperation : GTGitRepositoryOperation
{
...
+ (id)operationWithManagedObjectContext:(id)arg1 repository:(id)arg2 hotfixName:(id)arg3;
- (void).cxx_destruct;
...
- (id)title;
- (long long)type;
- (id)initWithManagedObjectContext:(id)arg1 repository:(id)arg2 hotfixName:(id)arg3;
