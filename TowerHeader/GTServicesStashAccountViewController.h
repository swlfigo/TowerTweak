...
@class GTDialogueWindowController, GTServiceAccount, GTServiceAccountCredentials, GTServicesStashAccountController, GTStateManager, NSAlert, NSString;

@interface GTServicesStashAccountViewController : GTDialogueViewController <GTServicesStashAccountControllerDelegate>
{
    BOOL _validating;
