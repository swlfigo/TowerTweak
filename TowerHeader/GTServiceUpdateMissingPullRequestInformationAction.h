...
@class GTGitRepository, GTServicePullRequest, GTServicePullRequestManager;

@interface GTServiceUpdateMissingPullRequestInformationAction : GTServiceAction
{
...
+ (id)actionWithServicePullRequest:(id)arg1 repository:(id)arg2;
- (void).cxx_destruct;
...
- (void)main;
- (id)initWithServicePullRequest:(id)arg1 repository:(id)arg2;
