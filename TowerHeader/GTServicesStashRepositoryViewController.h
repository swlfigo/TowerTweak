...
@class GTServiceAccount, GTServiceRepositoryCreationInfo, GTServicesStashRepositoryController, GTStateManager;

@interface GTServicesStashRepositoryViewController : GTDialogueViewController
{
    GTServiceAccount *_serviceAccount;
    GTServiceRepositoryCreationInfo *_serviceRepositoryCreationInfo;
    GTServicesStashRepositoryController *_repositoryController;
...
@property(retain, nonatomic) GTServicesStashRepositoryController *repositoryController; // @synthesize repositoryController=_repositoryController;
