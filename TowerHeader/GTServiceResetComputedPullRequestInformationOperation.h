...
@interface GTServiceResetComputedPullRequestInformationOperation : GTServiceOperation
{
    GTUpdateChangeset *_changeset;
    NSManagedObjectID *_servicePullRequestID;
}

+ (id)operationWithManagedObjectContext:(id)arg1 servicePullRequest:(id)arg2;
- (void).cxx_destruct;
...
- (void)execute;
- (id)initWithManagedObjectContext:(id)arg1 servicePullRequest:(id)arg2;
