...
@protocol GTGitFixupRevisionsActionDelegate;

@interface GTGitFixupRevisionsAction : GTGitWorkingCopyAction
{
    id <GTGitFixupRevisionsActionDelegate> _delegate;
    NSArray *_revisions;
...
@property(nonatomic) __weak id <GTGitFixupRevisionsActionDelegate> delegate; // @synthesize delegate=_delegate;
