...
@class GTDialogueWindowController, GTServiceAccount, GTServiceAccountCredentials, GTServicesAzureDevOpsServerAccountController, GTStateManager, NSAlert, NSString;

@interface GTServicesAzureDevOpsServerAccountViewController : GTDialogueViewController <GTServicesAzureDevOpsServerAccountControllerDelegate>
{
    BOOL _validating;
