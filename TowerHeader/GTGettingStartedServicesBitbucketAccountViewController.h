...
@class GTDialogueWindowController, GTServiceAccountCredentials, GTServicesBitbucketAccountController, GTStateManager, NSAlert, NSButton, NSString;

@interface GTGettingStartedServicesBitbucketAccountViewController : GTViewController <GTServicesBitbucketAccountControllerDelegate>
{
    BOOL _validating;
