...
@protocol GTGitSquashRevisionsActionDelegate;

@interface GTGitSquashRevisionsAction : GTGitWorkingCopyAction
{
    id <GTGitSquashRevisionsActionDelegate> _delegate;
    NSArray *_revisions;
...
@property(nonatomic) __weak id <GTGitSquashRevisionsActionDelegate> delegate; // @synthesize delegate=_delegate;
