...
@class GTAutocompleteItem, GTAvatarImageView, GTFileHistoryContributorFormatter, GTGitContributor, NSString;

@interface GTFileHistoryContributorAutocompleteCellView : GTAutocompleteCellView
{
    GTAvatarImageView *_avatarImageView;
    NSString *_contributorName;
    GTFileHistoryContributorFormatter *_formatter;
}
...
- (void).cxx_destruct;
@property(nonatomic) __weak GTFileHistoryContributorFormatter *formatter; // @synthesize formatter=_formatter;
