...
@class GTDialogueWindowController, GTServiceAccountCredentials, GTServicesBeanstalkAccountController, GTStateManager, NSAlert, NSButton, NSString;

@interface GTGettingStartedServicesBeanstalkAccountViewController : GTViewController <GTServicesBeanstalkAccountControllerDelegate>
{
    BOOL _validating;
