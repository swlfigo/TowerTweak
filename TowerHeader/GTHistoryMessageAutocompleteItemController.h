...
@class GTBackgroundSession, GTGitHistoryManager, GTGitRepository, GTSearchScopeFilter, NSArray, NSString;
@protocol GTAutocompleteItemControllerDelegate;

@interface GTHistoryMessageAutocompleteItemController : NSObject <GTAutocompleteItemController>
{
    BOOL _loading;
