...
@class NSString;
@protocol GTGitEditCommitMessageActionDelegate;

@interface GTGitEditCommitMessageAction : GTGitWorkingCopyAction
{
    id <GTGitEditCommitMessageActionDelegate> _delegate;
    NSString *_revision;
...
@property(nonatomic) __weak id <GTGitEditCommitMessageActionDelegate> delegate; // @synthesize delegate=_delegate;
