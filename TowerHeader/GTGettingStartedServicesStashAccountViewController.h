...
#import "GTServicesStashAccountControllerDelegate-Protocol.h"

@class GTDialogueWindowController, GTServiceAccountCredentials, GTServicesStashAccountController, GTStateManager, NSAlert, NSButton, NSString;

@interface GTGettingStartedServicesStashAccountViewController : GTViewController <GTServicesStashAccountControllerDelegate>
{
    BOOL _validating;
    ...
    GTServicesStashAccountController *_accountController;
...
@property(retain, nonatomic) GTServicesStashAccountController *accountController; // @synthesize accountController=_accountController;
...
- (void)stashAccountController:(id)arg1 didFailWithError:(id)arg2;
- (void)stashAccountControllerDidValidateCredentials:(id)arg1;
